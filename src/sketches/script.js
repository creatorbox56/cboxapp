//Code by Theresa Wilfer 02/2022
...
// Initialisierung ArrayList vom Typ Mover
var myMover1 = [];
var myMover2 = [];
var myMover3 = [];
var myMover4 = [];
...
function setup() {
    //Static Hash to check if the result is the same
    //Comment this line to check if the result is the same corresponding to the hash
...
function generate() {
    ...
    shapes = RA.random_int(20, 50);
    for (i = 0; i < shapes; i++) {
        myMover1[i] = new Mover(x, y, z, basic, lifetime);
    }
    shapes = RA.random_int(20, 50);
    for (i = 0; i < shapes; i++) {
        myMover2[i] = new Mover(x, y, z, bg, lifetime);

    }
    shapes = RA.random_int(20, 50);
    for (i = 0; i < shapes; i++) {
        myMover3[i] = new Mover(x, y, z, neon, lifetime);

    }
    shapes = RA.random_int(20, 50);
    for (i = 0; i < shapes; i++) {
        myMover4[i] = new Mover(x, y, z, spotlight, lifetime);
